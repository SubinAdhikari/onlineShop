...
const fields = ['productName','categoryName','subCategoryName', 'productCostPrice','productSellingPrice','totalInventry','status']
...
const ProductList = () =>{
  ...
  const deleteProduct = async (_id) =>{
    await axios.delete(`${process.env.REACT_APP_BACKEND_BASE_URL}/product/${_id}`)
    .then((response)=>{
        if(response.data){
