...
const PackedProductList = () =>{
  ...
  const deleteProduct = async (_id) =>{
    await axios.delete(`${process.env.REACT_APP_BACKEND_BASE_URL}/productPackage/${_id}`)
    .then((response)=>{
        if(response.data){
...
export default PackedProductList;